...
const classes: NavigationItemClasses = {
  root: tw``,
  link: tw`transitionbefore:absolute relative py-3 text-lg font-bold text-link before:-bottom-1 before:h-1 before:w-full before:bg-accent hover:text-link-light`,
};
