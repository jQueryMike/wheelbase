...
classes = {
  ...
  headingExtraLarge: {
    default: tw`text-body bg-heading relative -skew-x-[10deg] rounded-xl p-4 text-[20px] tracking-tighter`,
    sm: tw`sm:text-26px]`,
    md: tw`md:text-[30px]`,
    lg: tw`lg:text-[40px]`,
  },
  headingLarge: {
    default: tw`text-body bg-heading relative -skew-x-[10deg] rounded-xl p-3 text-[18px] tracking-tighter`,
    sm: tw`sm:text-22px]`,
    md: tw`md:text-[26px]`,
    lg: tw`lg:text-[32px]`,
  },
